...
# 4_Ethernet Over Twisted Pair

### Ethernet Over Twisted Pair tech

- An internet connection to a building or home is normally delivered through a coaxial cable and/or fiber-optic cable from an internet service provider.
- This connection is fed into a gateway modem located inside the building or home.
...
- These network cables are also called **CAT** cables. It is possible that you have purchased an Ethernet CAT5 or CAT6 cable.
